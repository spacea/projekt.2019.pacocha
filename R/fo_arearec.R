#' Rectangle area
#'
#' @description Function which calculates an area of a rectangle
#' based on its apexes.
#'
...
#'
#' @examples
#' fo_area.rec(0,0,4,0,4,5,0,5)
#' fo_area.rec(-5,-5,5,-5,5,5,-5,5)
fo_area.rec <- function(x1, y1, x2, y2, x3, y3, x4, y4){
